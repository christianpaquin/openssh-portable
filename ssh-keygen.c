...
type_bits_valid(int type, const char *name, u_int32_t *bitsp)
{
	...
	if (*bitsp == 0) {
		...
		CASE_KEY_ECDSA_HYBRID:
		  // FIXMEOQS: check code below, ok for PQ? this only used to break on ECDSA
			if (name != NULL &&
...
///// OQS_TEMPLATE_FRAGMENT_PRINT_PQ_RR_START
			n += do_print_resource_record(pw, _PATH_HOST_OQSDEFAULT_KEY_FILE, rr_hostname, print_generic);
			...
			n += do_print_resource_record(pw, _PATH_HOST_MQDSS_31_48_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L1FS_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L1UR_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L3FS_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L3UR_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L5FS_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC_L5UR_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC2_L1FS_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_PICNIC2_L3FS_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_QTESLA_P_I_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_QTESLA_P_III_KEY_FILE, rr_hostname, print_generic);
			n += do_print_resource_record(pw, _PATH_HOST_SPHINCS_HARAKA_128F_ROBUST_KEY_FILE, rr_hostname, print_generic);
